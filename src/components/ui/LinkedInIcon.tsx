...
// lucide-react in this project ships without brand glyphs (v1 moved them out),
// so the LinkedIn mark is an inline SVG. Shared by the footer and the blog
// author panel so there is one copy of the path.
